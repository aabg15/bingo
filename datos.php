                ...
                <div class="row p" id="contenedor_datos">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="nombre" placeholder="Nombres" value="<?php echo $nombre; ?>">
                    </div>

                    <div class="form-group">
                      <!-- <label for="id_apellidos_inpt">Apellidos</label> -->
                      <input type="text" class="form-control" id="apellido" placeholder="Apellidos" value="<?php echo $apellido; ?>">
                    </div>


                    <div class="form-group">
                      <!-- <label for="id_telefono_inpt">Telefono</label> -->
                      <input type="number" class="form-control" id="telefono" placeholder="Telefono" value="<?php echo $telefono; ?>">
                    </div>

                    <div class="form-group">
                      <!-- <label for="id_email_inpt">Correo electrónico</label> -->
                      <input type="email" class="form-control" id="correo" placeholder="Correo Electrónico" value="<?php echo $correo; ?>">
                    </div>

                    <div class="form-group">
                      <!-- <label for="id_direccion_inpt">Dirección</label> -->
                      <input type="text" class="form-control" id="direccion" placeholder="Dirección" value="<?php echo $direccion; ?>">
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="celular" placeholder="Celular" value="<?php echo $celular;?>">
                    ...
                    <div class="form-group">
                      ...
                      <?php
                        ...
                        <input type="text" class="form-control" id="departamento" name="departamento" placeholder="Departamento" value="<?php echo $departamento; ?>">
                      <?php
                      }
                    ...
                    <div class="form-group">
                      ...
                      <?php
                        ...
                        <input type="text" class="form-control" id="provincia" name="provincia" placeholder="Provincia" value="<?php echo $provincia; ?>">
                    ...
                    <div class="form-group">
                      ...
                      <?php
                        ...
                        <input type="text" class="form-control" id="distrito" name="distrito" placeholder="Distrito" value="<?php echo $distrito; ?>">
                    ...
                    <div class="form-group">
                      <div class="checkbox">
                        <label>
                          ...
                          Acepta los política de privacidad y uso de sus datos personales
                        </label>
                      </div>
                    </div>
