...
$consultaJugadad = "SELECT * FROM jugada where `id_cliente`=" . $dni." and id_sorteo=".$id_sorteo;
$jugadasObtenidas = array();
$result = (mysqli_query($con, $consultaJugadad));
...
$json_jugadas = json_encode($jugadasObtenidas, true);


$consultaJugadadR = "SELECT * FROM subjugada where `id_cliente`=" . $dni." and id_sorteo=".$id_sorteo;
$jugadasObtenidasRuleta = array();
$result1 = (mysqli_query($con, $consultaJugadadR));

$row1 = $result1->fetch_all();

foreach ($row1 as $obj1) {
  $jugadasObtenidasRuleta[] = array(
    "premios" => $obj1[3],
    "fechas" => $obj1[2]
  );
}
$json_jugadas1 = json_encode($jugadasObtenidasRuleta, true);

//estado, se envio  o no
  ...
  <div class="container">
    ...
    <div class="row justify-content-around align-items-center">
      ...
      <div class="col-auto p-5" id="juego">
        ...
        <center>
          <h5 style="color:#ff8000;">¡Gracias por participar!</h5>
        </center>
        ...
        <div id="formato-titulo">
          <center>
            <h5 style="color:black;">Recuerda que por cada S/500 soles en ahorro a plazo fijo, tienes una opcion extra para el LOTICAJA</h5>
          </center>
              ...
              function enviar_correo() {
                ...
                $.ajax({
                  ...
                  success: function(data) {
                    ...
                    //guardo el correo en la bd
                    /*                let dni = document.getElementById('dni_jugador').value;
                                   let id_sorteo =document.getElementById('id_sorteo').value;
                                   let estado = 'E';
                                   let correo = document.getElementById('correo').value;
                                   guardar_correo(dni,id_sorteo,estado,correo,x,y); */
                  }
                });
